...
SET Arbor.X.Build.NetAssembly.Copyright=© Niklas Lundberg 2018
SET Arbor.X.Build.NetAssembly.Trademark=Arbor.Tooler
SET Arbor.X.Build.NetAssembly.Product=Arbor.Tooler
